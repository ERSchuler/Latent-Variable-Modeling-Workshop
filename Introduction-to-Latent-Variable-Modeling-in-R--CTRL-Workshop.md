Introduction to Latent Variable Modeling in R
================
Eric R. Schuler, Ph.D.
...
![](Introduction-to-Latent-Variable-Modeling-in-R--CTRL-Workshop_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
...
Run overall Confirmatry factor analysis (CFA) sometimes called a
...
![](Introduction-to-Latent-Variable-Modeling-in-R--CTRL-Workshop_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
The first one we could just add the variable to the other factor. If we
...
```
    ...
    ##     word_meaning      0.925    0.055   16.722    0.000
    ##   speed =~                                            
    ##     speeded_additn    1.000                           
...
We will now create a much better table, we will start by extracting the
...
the loadings (or path coefficients) are the same for each group. If they
are not, then that means that the constructs are manifested differently
in the groups. Constrain path coefficients (loadings) to be the same
across groups
...
<div id="igjjjatqhg" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>html {
  font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Helvetica Neue', 'Fira Sans', 'Droid Sans', Arial, sans-serif;
}
...
#igjjjatqhg .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#igjjjatqhg .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#igjjjatqhg .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#igjjjatqhg .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#igjjjatqhg .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#igjjjatqhg .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#igjjjatqhg .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#igjjjatqhg .gt_from_md > :first-child {
  margin-top: 0;
}

#igjjjatqhg .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#igjjjatqhg .gt_first_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#igjjjatqhg .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#igjjjatqhg .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#igjjjatqhg .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#igjjjatqhg .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#igjjjatqhg .gt_footnote {
  margin: 0px;
  font-size: 90%;
  padding: 4px;
}

#igjjjatqhg .gt_sourcenotes {
  color: #333333;
  background-color: #FFFFFF;
  border-bottom-style: none;
  border-bottom-width: 2px;
...
#igjjjatqhg .gt_font_normal {
  font-weight: normal;
}

#igjjjatqhg .gt_font_bold {
  font-weight: bold;
}

#igjjjatqhg .gt_font_italic {
  font-style: italic;
}
...
```
    ...
    ## lavaan 0.6-10 ended normally after 22 iterations
    ## 
    ##   Estimator                                         ML
    ##   Optimization method                           NLMINB
...
![](Introduction-to-Latent-Variable-Modeling-in-R--CTRL-Workshop_files/figure-gfm/unnamed-chunk-62-1.png)<!-- -->
...
![](Introduction-to-Latent-Variable-Modeling-in-R--CTRL-Workshop_files/figure-gfm/unnamed-chunk-66-1.png)<!-- -->
...
![](Introduction-to-Latent-Variable-Modeling-in-R--CTRL-Workshop_files/figure-gfm/unnamed-chunk-70-1.png)<!-- -->
...
![](Introduction-to-Latent-Variable-Modeling-in-R--CTRL-Workshop_files/figure-gfm/unnamed-chunk-74-1.png)<!-- -->
...
```
    ...
    ##        gt   tidySEM    OpenMx  semTable   semPlot  semTools     psych    lavaan 
    ##   "0.3.1"   "0.2.0"  "2.20.0"     "1.8"   "1.1.2"   "0.5-5"   "2.1.9"  "0.6-10" 
    ##   forcats   stringr     dplyr     purrr     readr     tidyr    tibble   ggplot2 
    ##   "0.5.1"   "1.4.0"   "1.0.7"   "0.3.4"   "2.1.1"   "1.1.4"   "3.1.5"   "3.3.5" 
    ## tidyverse 
    ##   "1.3.1"
...
-   Curran and Bauer SEM in R handout:
    <https://centerstat.org/wp-content/uploads/2019/04/SEM-R-notes-2019-3.pdf>
-   *free Curran and Bauer* archived workshop (FREE!!!):
    <https://centerstat.org/introduction-to-structural-equation-modeling/?utm_source=past+and+possible+Participants&utm_campaign=bccb9615c8-April+Blast+2017_COPY_01&utm_medium=email&utm_term=0_64662a4a83-bccb9615c8-206777798&mc_cid=bccb9615c8&mc_eid=f87f6096a0>
...
-   UCLA IDRE Workshop: <https://stats.idre.ucla.edu/r/seminars/rcfa/>
    and <https://stats.idre.ucla.edu/r/seminars/rsem/>
-   <https://benwhalley.github.io/just-enough-r/cfa.html>

Books:

-   Bollen, K. A. (1989). Measurement models: The relation between
    latent and observed variables. Structural equations with latent
    variables, 179-225.
-   Finch, W. H., & French, B. F. (2015). Latent variable modeling
    with R. Routledge.
